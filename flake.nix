{
  description = "explicit-trust-plane - {project-description}";
    ...
    flake-utils.lib.eachDefaultSystem (system:
      ...
      in
      {
        ...
        devShells.default = pkgs.mkShell {
          ...
          shellHook = ''
            echo "🚀 explicit-trust-plane development environment"
        ...
        packages.default = pkgs.stdenv.mkDerivation {
          ...
          buildPhase = ''
            ...
            # For Ada: gprbuild -P explicit-trust-plane.gpr -XMODE=release
          '';

          installPhase = ''
            mkdir -p $out/bin
            # *REMINDER: Add install commands*
            # cp target/release/explicit-trust-plane $out/bin/  # Rust
            # cp bin/explicit-trust-plane $out/bin/  # Ada
          '';
        ...
        apps.default = {
          type = "app";
          program = "${self.packages.${system}.default}/bin/explicit-trust-plane";
        };
        ...
        checks = {
          ...
          test = pkgs.runCommand "test-explicit-trust-plane" {
