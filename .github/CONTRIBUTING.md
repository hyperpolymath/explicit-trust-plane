...
git clone <https://github.com/hyperpolymath/explicit-trust-plane.git> cd
...
toolbox create explicit-trust-plane-dev toolbox enter
explicit-trust-plane-dev \# Install dependencies manually
...
explicit-trust-plane/ ├── src/ \# Source code (Perimeter 1-2) ├── lib/
...
Task runner (Perimeter 1)
    ...
    **When suggesting**:
    ...
    - [`good first issue`](https://github.com/hyperpolymath/explicit-trust-plane/labels/good%20first%20issue) — Simple Perimeter 3 tasks
    - [`help wanted`](https://github.com/hyperpolymath/explicit-trust-plane/labels/help%20wanted) — Community help needed
    - [`documentation`](https://github.com/hyperpolymath/explicit-trust-plane/labels/documentation) — Docs improvements
    - [`perimeter-3`](https://github.com/hyperpolymath/explicit-trust-plane/labels/perimeter-3) — Community sandbox scope
