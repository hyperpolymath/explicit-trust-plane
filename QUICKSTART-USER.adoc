= Explicit Trust Plane — User Quickstart
:toc: preamble
...
[source,bash]
----
git clone https://github.com/hyperpolymath/explicit-trust-plane
...
* https://github.com/hyperpolymath/explicit-trust-plane/issues — report bugs
